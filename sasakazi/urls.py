...
urlpatterns=[
    ...
    path('accounts/<int:id>/', AccountListCreateAPIView.as_view(), name='account-retrieve-update-destroy'),
    path('cards/', CardListCreateAPIView.as_view(), name='card-list-create'),
    path('cards/<int:id>/', CardListCreateAPIView.as_view(), name='card-retrieve-update-destroy'),
